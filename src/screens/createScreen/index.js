        ...
        return (
            <View style={styles.container}>
                <View style={width > 660 ? styles.noUserContainTablet : styles.noUserContain}>
                    ...
                    <Text style={width > 660 ? styles.noUserTextSubTablet : styles.noUserTextSub}>
                        Go to Profile and create User and ShipId to be able to publish, don't forget to upload a picture!
                    </Text>
                </View>
                {isLoadingUserData && (
    ...
    return (
        <View style={styles.container}>
            <View style={width > 660 ? styles.buttonContainerTablet : styles.buttonContainer}>
                <TouchableOpacity
                    style={[width > 660 ? styles.buttonContainerTablet : styles.buttonContainer, { opacity: isButtonDisabled ? 0.5 : 1 }]}
